...
func main() {
	...
	tee.WorkerID = "hardcoded-worker-id-for-testing"
	logrus.Info("Using hardcoded worker ID for testing: ", tee.WorkerID)

	// Skip worker ID initialization to avoid SGX errors
